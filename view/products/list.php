                          ...
                          <tbody>
                            <?php foreach ($data as $key ) { ?>
                              <tr>
                                  ...
                                  <td><img src="lib/img/<?= $key['path'] ?>" alt=""></td>
                                  <td>
                                      <a href="index.php?controller=product&action=editview&id=<?= $key['product_id'] ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                      <a onclick=" return confirm('ok') " href="index.php?controller=product&action=delete&id=<?= $key['product_id'] ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                  </td>
                              </tr>
                            <?php } ?>
                          </tbody>
